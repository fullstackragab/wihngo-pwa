...
// Solana configuration is fetched from backend API at runtime
// See: src/lib/solana/phantom.ts - getSolanaConfig()
// Endpoint: GET /api/payments/config
//
// This ensures frontend and backend are always in sync for:
